...
public class ParallelizableOperation3AdvisorTest {
	...
	public void prepareTest() throws Exception {
		cache = new CacheBuilder<AdviceKey, Boolean>("op3").build();
		cache.clear();
		advisor = new ParallelizableOperation3Advisor(TEST_COUNT, cache);
