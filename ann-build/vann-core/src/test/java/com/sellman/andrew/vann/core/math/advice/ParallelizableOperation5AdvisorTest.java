...
public class ParallelizableOperation5AdvisorTest {
	...
	public void prepareTest() throws Exception {
		cache = new CacheBuilder<AdviceKey, Boolean>("op5").build();
		cache.clear();
		advisor = new ParallelizableOperation5Advisor(TEST_COUNT, cache);
